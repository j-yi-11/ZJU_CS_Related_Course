...
;             ADD  R5,  R1,  R3
;             BRp  IsLetter
; IsNumber    LD  R3,  _ASCII_9
;             ADD  R3,  R3,  #-9
;             NOT  R3,  R3
;             ADD  R3,  R3,  #1          ; R3 = -x30
;             ADD  R1,  R1,  R3
;             ADD  R2,  R2,  R1
;             ADD  R2,  R2,  #1          ; Offset for the next line
;             BRnzp  Restore
; IsLetter    ADD  R4,  R1,  #0
;             BRnzp  Restore
; Restore     LDR  R5,  R0,  #3
;             LDR  R3,  R0,  #2
;             LDR  R1,  R0,  #1
...
; ;
;             .ORIG  x3000
;             LD  R2,  LeftPos         ; R2 is the left position
;             LD  R4,  ASCII_a         ; R4 is the current letter
;             ADD  R5,  R2,  #2
;             NOT  R5,  R5
;             ADD  R5,  R5,  #1          ; R5 = -#19
; MainLoop    AND  R1,  R1,  #0          ; R1 is the current position
;             LD  R3,  LeftPos
;             NOT  R3,  R3
;             ADD  R3,  R3,  #1          ; R3 = -#17
;             ADD  R3,  R2,  R3
...
;             BRzp  ValidPos
;             AND  R2,  R2,  #0
; ValidPos    BRnzp  MainLoop
; ;
; Delay       LD  R0,  DelayTime
; DelayLoop   ADD  R0,  R0,  #-1
;             BRp  DelayLoop
;             RET
; ;
; LeftPos     .FILL  #17
